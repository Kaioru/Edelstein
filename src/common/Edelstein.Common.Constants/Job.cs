...
public static class Job
{
    ...
    public const int ArchmageFirePoison = 212;
    public const int WizardThunderCold = 220;
    public const int MageThunderCold = 221;
    public const int ArchmageThunderCold = 222;
    ...
    public const int Thief = 420;
    public const int Thiefmaster = 421;
    public const int Shadower = 422;
    public const int Dual1 = 430;
    public const int Dual2 = 431;
