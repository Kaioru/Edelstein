...
namespace Edelstein.Common.Database.Migrations
{
    ...
    [Migration("20230821110637_AddBasicEntities")]
            ...
            modelBuilder.Entity("Edelstein.Common.Database.Entities.AccountWorldEntity", b =>
                {
                    ...
                    b.Property<IItemLocker>("Locker")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasAnnotation("Relational:JsonPropertyName", "locker");

                    b.Property<IItemTrunk>("Trunk")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasAnnotation("Relational:JsonPropertyName", "trunk");
            ...
            modelBuilder.Entity("Edelstein.Common.Database.Entities.CharacterEntity", b =>
                {
                    ...
                    b.Property<IDictionary<ItemInventoryType, IItemInventory>>("Inventories")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasAnnotation("Relational:JsonPropertyName", "inventories");
