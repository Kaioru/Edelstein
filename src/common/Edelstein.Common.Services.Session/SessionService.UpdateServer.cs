...
{
    public async Task<SessionServiceResponse> UpdateServer(SessionServiceUpdateServerRequest request, CallContext context = default)
    {
        try
        {
            ...
            var count = await db.SessionInfo
                ...
                .ExecuteUpdateAsync(s => s
                    .SetProperty(p => p.ServerID, request.ServerID));
