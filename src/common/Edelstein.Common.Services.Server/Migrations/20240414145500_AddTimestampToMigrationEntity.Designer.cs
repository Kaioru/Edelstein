...
namespace Edelstein.Common.Services.Server.Migrations
{
    ...
    [Migration("20240414145500_AddTimestampToMigrationEntity")]
    partial class AddTimestampToMigrationEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edelstein.Common.Services.Server.Entities.ServerEntityGame", b =>
                {
            ...
            modelBuilder.Entity("Edelstein.Common.Services.Server.Entities.ServerEntityLogin", b =>
                {
                    b.HasBaseType("Edelstein.Common.Services.Server.Entities.ServerEntity");
            ...
            modelBuilder.Entity("Edelstein.Common.Services.Server.Entities.ServerEntityShop", b =>
                {
                    b.HasBaseType("Edelstein.Common.Services.Server.Entities.ServerEntity");
                    ...
                    b.ToTable("servers", null, t =>
                        {
                            t.Property("WorldID")
                                .HasColumnName("ServerEntityShop_WorldID");
                        });

                    b.HasDiscriminator().HasValue("Shop");
                });

            modelBuilder.Entity("Edelstein.Common.Services.Server.Entities.ServerEntityTrade", b =>
                {
                    b.HasBaseType("Edelstein.Common.Services.Server.Entities.ServerEntity");
                    ...
                    b.ToTable("servers", null, t =>
                        {
                            t.Property("WorldID")
                                .HasColumnName("ServerEntityTrade_WorldID");
                        });
